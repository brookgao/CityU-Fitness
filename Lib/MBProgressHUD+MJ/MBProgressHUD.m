...
- (void)layoutSubviews {
    ...
    NSDictionary *labelDict = @{NSFontAttributeName:label.font};
	//CGSize labelSize = [label.text sizeWithFont:label.font];
    CGSize labelSize = [label.text sizeWithAttributes:labelDict];
    ...
    NSDictionary *detailsLabelDict = @{NSFontAttributeName:detailsLabel.font};
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:detailsLabelDict context:nil].size;
